...
---
# Creating a Vanilla Style Shield(Architectury)

## Step 1.
Register a shield. click [here](https://discord.architectury.dev/) for the Architectury Discord

```java
public final class ExampleModItems {

    public static DeferredRegistry<Item> ITEMS;

    public static RegistrySupplier<Item> EXAMPLE_SHIELD;

    public static void commonInit() {
        ITEMS = DeferredRegister.create(ExampleMod.MOD_ID, Registries.ITEM);
        //Creates deferred registry

        //Add new shield
        EXAMPLE_SHIELD = registerItem("example_shield",
        ...
        //Registers all items to minecraft(cannot add more after this line)
        ITEMS.register();
    }

    public static <T extends Item> RegistrySupplier<T> registerItem(String name, Function<Item.Properties, T> itemFactory) {
        return ITEMS.register(name, () -> {
            ...
            //Return & Create item instance with new properties instance.
...
### Add `ExampleModItems.init()` to NeoForge/Fabric.
- Fabric
```java
